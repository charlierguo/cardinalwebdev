# Django settings for cardinalwebdev project.
...
DATABASES = {
    'default': {
        ...
        'NAME':  'cardinalwebdev',                      # Or path to database file if using sqlite3.
        'USER': 'cardinalwebdev_user',                      # Not used with sqlite3.
        'PASSWORD': 'X0FejrQPs9qe4FXyHeuIcJsmmqz8cD',                  # Not used with sqlite3.
...
SECRET_KEY = '?~tCspS(ijQ=9AT\\):JV[^M#e&y1E?S|J@Qk$B^XPNfDci8rB'
...
ROOT_URLCONF = 'cardinalwebdev.urls'

WSGI_APPLICATION = 'cardinalwebdev.wsgi.application'
